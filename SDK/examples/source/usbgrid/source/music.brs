...
' return a list of files with playable music extensions
	return get_filelist(filelist, "^.+\.(?:mp3|wma|m4a)$")
end Function
...
function newMusicContainer()
    container = newContentContainer("music", findmusic, "icon-music-hd.jpg", "icon-music-sd.jpg", PlayMusic, musicsettings, false )
    return container
end function
