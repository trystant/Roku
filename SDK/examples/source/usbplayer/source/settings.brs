...
Sub doRepeatModeScreen(container, port)
    ...
    screen.SetDefaultMenuItem(container.repeatmode)
...
Function newSettingsContainer()
    container = newContentContainer("settings", findsettings, "Provider_Settings_Center_HD.png", "Provider_Settings_Center_HD.png", ShowSettings, settingssettings)
