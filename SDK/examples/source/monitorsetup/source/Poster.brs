'**********************************************************
'**  Monitor Setup Example Application - slideshow
'**  August 2009
...
Function StartPosterScreen(PosterList as object,focus as integer, a as string, b as string) as Object
    scr = create_posterscreen(a,b)
    scr.LoadFeed(PosterList.Posteritems)
    scr.screen.SetFocusedListItem(focus)
    return scr
End function

REM ******************************************************
REM
REM create an associate array with these new items and return it
REM
REM ******************************************************
